...
<head>
    ...
    <title>Editar Perfil - Plataforma Artesanos Junín</title>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="bio" required rows="3"
                              ...
                              placeholder="Cuéntanos sobre tu arte...">{{ old('bio', $profile->bio) }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="bank_details" rows="2"
                              ...
                              placeholder="Cuenta BCP: 123-4567890-1-23">{{ old('bank_details', $profile->bank_details) }}</textarea>
                </div>
                @endif
