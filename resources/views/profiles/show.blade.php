    ...
    <div class="max-w-2xl w-full bg-white p-10 rounded-2xl shadow-2xl">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-600">{{ $profile->bio ?? 'Sin biografía' }}</p>
            </div>
            @endif
            ...
            <div>
                ...
                <p class="mt-2 text-gray-600">{{ $profile->address }}</p>
            </div>
            ...
            <div>
                ...
                <p class="mt-2 text-gray-600">{{ $profile->bank_details ?? 'No especificado' }}</p>
            </div>
            @endif
            ...
            <div>
                ...
                <p class="mt-2 text-gray-600">{{ $profile->phone }}</p>
            </div>
            @endif
        </div>
