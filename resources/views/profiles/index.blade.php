        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                <a href="{{ route('artisans.profile', $artisan) }}" 
                   class="block bg-white/95 backdrop-blur-sm p-6 rounded-2xl shadow-lg card-hover transition-all duration-300 border border-amber-100 group">
                    ...
                    <div class="flex items-center mb-5">
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            @if($artisan->shop_name)
                                <p class="text-sm text-amber-600 italic truncate">"{{ $artisan->shop_name }}"</p>
                            @endif
                        </div>
                    </div>
                    ...
                    <p class="text-gray-700 text-sm line-clamp-3 mb-3">
                        {{ $artisan->bio ?? 'Artesano dedicado a preservar la tradición andina.' }}
                    </p>
            ...
            @empty
                <div class="col-span-full text-center py-20 bg-white/80 backdrop-blur rounded-3xl shadow-xl">
                    ...
                    <a href="{{ route('register') }}" class="mt-6 inline-block bg-amber-600 text-white px-6 py-3 rounded-xl hover:bg-amber-700 transition shadow">
