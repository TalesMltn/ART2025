    ...
    <div class="flex-grow container mx-auto px-6 py-12">
        ...
        @if($slug === 'textiles-y-tejidos')
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="{{ asset('images/textiles/poncho.png') }}" alt="Poncho" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="{{ asset('images/textiles/manta.png') }}" alt="Manta" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="{{ asset('images/textiles/chullos.png') }}" alt="Chullo" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="{{ asset('images/textiles/bufandas.png') }}" alt="Bufanda" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="{{ asset('images/ceramicas/vasija.png') }}" alt="Vasija" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="{{ asset('images/ceramicas/olla.png') }}" alt="Olla" class="w-full h-48 object-cover rounded-lg mb-4">
                <h2 class="text-xl font-bold text-[#5a2d0c]">Ollas</h2>
                <p class="text-sm text-gray-600 mt-2">Perfectas para cocinar a fuego lento.</p>
            </div>

            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="{{ asset('images/ceramicas/figura ritual.png') }}" alt="Figura ritual" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="{{ asset('images/ceramicas/souvenir.png') }}" alt="Souvenir" class="w-full h-48 object-cover rounded-lg mb-4">
