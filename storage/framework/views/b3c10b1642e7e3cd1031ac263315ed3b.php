...
<head>
    ...
    <title><?php echo e($artisan->user->name); ?> - Artesano en Junín</title>
...
<body class="bg-gradient-to-br from-amber-50 to-orange-100 min-h-screen py-12 px-4">
    ...
    <div class="max-w-5xl mx-auto">
        <!-- BOTÓN VOLVER -->
        <div class="mb-8">
            <a href="<?php echo e(route('artisans.index')); ?>" 
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-amber-500 to-orange-600 p-8 text-white">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold"><?php echo e($artisan->user->name); ?></h1>
                        <?php if($artisan->shop_name): ?>
                            <p class="text-2xl italic opacity-90">"<?php echo e($artisan->shop_name); ?>"</p>
                        <?php endif; ?>
            ...
            <div class="p-8 space-y-8">
                <div>
                    ...
                    <p class="text-gray-700 leading-relaxed text-lg">
                        <?php echo e($artisan->bio ?? 'Artesano dedicado a preservar las tradiciones andinas con pasión y excelencia.'); ?>

                    </p>
                </div>

                <?php if($artisan->bank_details): ?>
                <div class="bg-amber-50 p-6 rounded-2xl border border-amber-200">
                    ...
                    <p class="text-gray-700 whitespace-pre-line"><?php echo e($artisan->bank_details); ?></p>
                </div>
                <?php endif; ?>

                <?php if($artisan->projects->count() > 0): ?>
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <?php $__currentLoopData = $artisan->projects->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-gray-50 p-4 rounded-xl border border-gray-200 card-hover">
                            <h4 class="font-semibold text-gray-800"><?php echo e($project->title); ?></h4>
                            <p class="text-sm text-gray-600 mt-1"><?php echo e(Str::limit($project->description, 80)); ?></p>
                            <?php if($project->price): ?>
                                <p class="text-amber-600 font-bold mt-2">S/ <?php echo e(number_format($project->price, 2)); ?></p>
                            <?php endif; ?>
                        </div>
                ...
                <div class="text-center pt-6 border-t border-gray-200">
                    <a href="<?php echo e(route('messages.send.form', $artisan->user_id)); ?>" 
                ...
                <div class="text-center pt-6 border-t border-gray-200">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center bg-teal-600 text-white font-bold px-8 py-4 rounded-xl shadow-lg hover:bg-teal-700 transition">
...
</html><?php /**PATH D:\ArtesanosJunin2025\resources\views/profiles/public-show.blade.php ENDPATH**/ ?>