...
<body class="bg-gradient-to-br from-teal-50 to-green-100 min-h-screen py-12 px-4">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-8">
            <form method="POST" action="<?php echo e(route('contacto.submit')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" required
                               class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-teal-500 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" required
                               class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-teal-500 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="subject" required
                           class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-teal-500 <?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="message" rows="6" required
                              class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-teal-500 <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
</html><?php /**PATH D:\ArtesanosJunin2025\resources\views/contacto.blade.php ENDPATH**/ ?>