    ...
    <div class="flex-grow container mx-auto px-6 py-12">
        ...
        <?php if($slug === 'textiles-y-tejidos'): ?>
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="<?php echo e(asset('images/textiles/poncho.png')); ?>" alt="Poncho" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="<?php echo e(asset('images/textiles/manta.png')); ?>" alt="Manta" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="<?php echo e(asset('images/textiles/chullos.png')); ?>" alt="Chullo" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="<?php echo e(asset('images/textiles/bufandas.png')); ?>" alt="Bufanda" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="<?php echo e(asset('images/ceramicas/vasija.png')); ?>" alt="Vasija" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="<?php echo e(asset('images/ceramicas/olla.png')); ?>" alt="Olla" class="w-full h-48 object-cover rounded-lg mb-4">
                <h2 class="text-xl font-bold text-[#5a2d0c]">Ollas</h2>
                <p class="text-sm text-gray-600 mt-2">Perfectas para cocinar a fuego lento.</p>
            </div>

            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="<?php echo e(asset('images/ceramicas/figura ritual.png')); ?>" alt="Figura ritual" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                <img src="<?php echo e(asset('images/ceramicas/souvenir.png')); ?>" alt="Souvenir" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <?php elseif($slug === 'madera-tallada'): ?>
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/madera/mueble.png')); ?>" alt="Mueble pequeño" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/madera/utensilio.png')); ?>" alt="Utensilio" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/madera/figura.png')); ?>" alt="Figura decorativa" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/madera/escultura.png')); ?>" alt="Escultura" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <?php elseif($slug === 'mates-burilados'): ?>
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center col-span-full md:col-span-1">
                    <img src="<?php echo e(asset('images/mates/burilado.png')); ?>" alt="Mate burilado" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <?php elseif($slug === 'joyeria-bisuteria'): ?>
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/joyeria/collar.png')); ?>" alt="Collar" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/joyeria/pulsera.png')); ?>" alt="Pulsera" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/joyeria/anillo.png')); ?>" alt="Anillo" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/joyeria/aretes.png')); ?>" alt="Aretes" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <?php elseif($slug === 'cuero-talabarteria'): ?>
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/cuero/bolso.png')); ?>" alt="Bolso" class="w-full h-48 object-cover rounded-lg mb-4">
                    <h2 class="text-xl font-bold text-[#5a2d0c]">Bolsos</h2>
                    <p class="text-sm text-gray-600 mt-2">Cuero curtido vegetal, cosido a mano.</p>
                </div>

                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/cuero/cartera.png')); ?>" alt="Cartera" class="w-full h-48 object-cover rounded-lg mb-4">
                    <h2 class="text-xl font-bold text-[#5a2d0c]">Carteras</h2>
                    <p class="text-sm text-gray-600 mt-2">Diseños prácticos y duraderos.</p>
                </div>

                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/cuero/cinturon.png')); ?>" alt="Cinturón" class="w-full h-48 object-cover rounded-lg mb-4">
                    <h2 class="text-xl font-bold text-[#5a2d0c]">Cinturones</h2>
                    <p class="text-sm text-gray-600 mt-2">Con hebillas de bronce o alpaca.</p>
                </div>

                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/cuero/zapato.png')); ?>" alt="Zapato" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <?php elseif($slug === 'cesteria-fibras-vegetales'): ?>
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/cesteria/canasta.png')); ?>" alt="Canasta" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/cesteria/sombrero.png')); ?>" alt="Sombrero" class="w-full h-48 object-cover rounded-lg mb-4">
                    <h2 class="text-xl font-bold text-[#5a2d0c]">Sombreros</h2>
                    <p class="text-sm text-gray-600 mt-2">Protección solar y estilo andino.</p>
                </div>

                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/cesteria/tapiz.png')); ?>" alt="Tapiz" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/cesteria/adorno.png')); ?>" alt="Adorno" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <?php elseif($slug === 'instrumentos-musicales'): ?>
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/instrumentos/flauta.png')); ?>" alt="Flauta de caña" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/instrumentos/charango.png')); ?>" alt="Charango" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/instrumentos/bombo.png')); ?>" alt="Bombo" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <?php elseif($slug === 'arte-decorativo'): ?>
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/arte/figurilla.png')); ?>" alt="Figurilla" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/arte/escultura.png')); ?>" alt="Escultura" class="w-full h-48 object-cover rounded-lg mb-4">
                    <h2 class="text-xl font-bold text-[#5a2d0c]">Esculturas</h2>
                    <p class="text-sm text-gray-600 mt-2">Piezas de arte en madera, piedra o arcilla.</p>
                </div>

                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/arte/adorno.png')); ?>" alt="Adorno" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition hover:bg-yellow-50 text-center">
                    <img src="<?php echo e(asset('images/arte/recuerdo.png')); ?>" alt="Recuerdo" class="w-full h-48 object-cover rounded-lg mb-4">
