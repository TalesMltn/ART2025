    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-xl p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('artisans.index')); ?>" class="text-teal-600 hover:text-teal-800">
            ...
            <?php if(count($conversations) > 0): ?>
                <div class="space-y-4">
                    ...
                    <a href="<?php echo e(route('messages.send.form', $conv['user']->id)); ?>" 
                       class="block p-4 bg-teal-50 hover:bg-teal-100 rounded-xl transition flex items-center space-x-4">
                        <div class="w-12 h-12 bg-teal-500 rounded-full flex items-center justify-center text-white font-bold">
                            <?php echo e(strtoupper(substr($conv['user']->name, 0, 2))); ?>

                        </div>
                        <div class="flex-1">
                            <h3 class="font-semibold text-gray-800"><?php echo e($conv['user']->name); ?></h3>
                            <p class="text-sm text-gray-600"><?php echo e(Str::limit($conv['last_message']->content, 50)); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-xs text-gray-500"><?php echo e($conv['last_message']->created_at->format('d/m H:i')); ?></p>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <a href="<?php echo e(route('artisans.index')); ?>" class="mt-4 inline-block text-teal-600 hover:underline">
                        Explorar artesanos
                    </a>
                </div>
            <?php endif; ?>
...
</html><?php /**PATH D:\ArtesanosJunin2025\resources\views/messages/index.blade.php ENDPATH**/ ?>