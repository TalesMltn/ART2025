...
<?php $__env->startSection('title', $project->title . ' - Artesanos Junín'); ?>
...
<div class="container mx-auto p-6 max-w-7xl">
    ...
    <div class="flex flex-wrap justify-between items-center mb-10 gap-6">
        ...
        <a href="<?php echo e(route('ratings.gallery')); ?>" target="_blank"
        class="inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold px-8 py-4 rounded-xl shadow-xl transition transform hover:scale-105">
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
        ...
        <div class="bg-gradient-to-r from-indigo-600 to-purple-700 p-10 text-white">
            <h1 class="text-4xl md:text-5xl font-extrabold"><?php echo e($project->title); ?></h1>
            <div class="flex flex-wrap items-center gap-6 mt-6 text-lg opacity-90">
                <span>Publicado el <?php echo e($project->created_at->format('d/m/Y')); ?></span>
        ...
        <div class="p-10">
            ...
            <div class="grid md:grid-cols-3 gap-10 mb-12">
                ...
                <div class="text-center">
                    <div class="w-28 h-28 mx-auto bg-indigo-100 rounded-full flex items-center justify-center text-4xl font-bold text-indigo-600 shadow-lg">
                        <?php echo e($project->client?->user ? strtoupper(substr($project->client->user->name, 0, 2)) : '??'); ?>

                    </div>
                    <p class="mt-4 text-sm text-gray-600">Publicado por</p>
                    <p class="text-2xl font-bold text-gray-800"><?php echo e($project->client?->user?->name ?? 'Anónimo'); ?></p>
                </div>
                ...
                <div class="text-center">
                    <?php if($project->artisan?->user): ?>
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e($project->artisan->user->name); ?></p>
                ...
                <div class="text-center md:text-right">
                    ...
                    <?php if($project->price): ?>
                        <p class="text-5xl font-extrabold text-indigo-600 mt-3">S/ <?php echo e(number_format($project->price, 0, ',', '.')); ?></p>
                    <?php else: ?>
            ...
            <div class="mt-12 flex flex-wrap gap-6 justify-center">
                <?php if(auth()->user()->isClient() && $project->client_id == auth()->user()->client?->id && is_null($project->artisan_id)): ?>
                    <a href="<?php echo e(route('projects.edit', $project)); ?>" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-4 px-10 rounded-xl shadow-lg transition text-xl">
                        Editar Proyecto
                    </a>
                <?php endif; ?>

                <?php if(auth()->user()->isArtisan() && $project->artisan_id == auth()->user()->artisan?->id): ?>
                    <a href="<?php echo e(route('projects.edit', $project)); ?>" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-4 px-10 rounded-xl shadow-lg transition text-xl">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ArtesanosJunin2025\resources\views/projects/show.blade.php ENDPATH**/ ?>