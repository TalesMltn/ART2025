...
<?php $__env->startSection('title', 'Artesanos Junín - Conexión de Empleo'); ?>

<?php $__env->startSection('content'); ?>

<!-- Hero principal -->
<section class="hero text-center py-16 bg-cover bg-center relative"
         style="background-image: url('<?php echo e(asset('images/inti.png')); ?>');">
        ...
        <div class="p-8 bg-white/95 rounded-2xl border shadow-lg hover:shadow-xl transition max-w-3xl mx-auto">
            ...
            <div class="flex justify-center gap-4">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php elseif(Auth::user()->role === 'artesano'): ?>
...
<section class="py-16 bg-cover bg-center bg-fixed"
         style="background-image: url('<?php echo e(asset('images/jarron.png')); ?>');">
...
<div class="text-center mt-16">
    <a href="<?php echo e(route('contacto.submit')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ArtesanosJunin2025\resources\views/home.blade.php ENDPATH**/ ?>